...
export interface ApiDashboardDashboard extends Schema.SingleType {
  ...
  attributes: {
    ...
    headline_chip: Attribute.String;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
...
export interface ApiFaqFaq extends Schema.SingleType {
  ...
  attributes: {
    FAQ: Attribute.Component<'participation.faq', true>;
...
export interface ApiHypeHype extends Schema.SingleType {
  collectionName: 'hypes';
  info: {
    singularName: 'hype';
    pluralName: 'hypes';
    displayName: 'Hype';
  ...
  attributes: {
    ...
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<'api::hype.hype', 'oneToOne', 'admin::user'> &
      Attribute.Private;
    updatedBy: Attribute.Relation<'api::hype.hype', 'oneToOne', 'admin::user'> &
      Attribute.Private;
  };
}
...
export interface ApiParticipationParticipation extends Schema.SingleType {
  ...
  attributes: {
    intro: Attribute.Blocks;
    window_start_dt: Attribute.DateTime;
    window_end_dt: Attribute.DateTime;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
...
export interface ApiRouteRoute extends Schema.CollectionType {
  ...
  attributes: {
    startLocation: Attribute.Component<'participation.location'> &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: false;
        };
      }>;
    endLocation: Attribute.Component<'participation.location'> &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: false;
        };
    ...
    layers: Attribute.Relation<
      ...
      'api::map-layer.map-layer'
    >;
    makeNameLayer: Attribute.Boolean &
      Attribute.Required &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
    ...
    mode: Attribute.Enumeration<['run', 'walk', 'ruck', 'way-points']> &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    distanceUnit: Attribute.Enumeration<
      ['kilometers', 'miles', 'steps', 'track laps']
    > &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
...
export interface ApiSponsorSponsor extends Schema.SingleType {
  ...
  attributes: {
    intro: Attribute.Blocks & Attribute.Required;
    sponsors: Attribute.Component<'sponsorship.sponsor', true> &
      Attribute.Required;
...
export interface ApiWaiverWaiver extends Schema.SingleType {
